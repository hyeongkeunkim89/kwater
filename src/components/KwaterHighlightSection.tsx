...
const HIGHLIGHT_ITEMS: HighlightItem[] = [
  ...
  {
    id: "water-guide-1",
    title: "전국 15대 댐 물문화관 실감 영상 & 전시 체험 공간",
    desc: "전국 15개 거점 물문화관의 디지털 파노라마, 미디어아트, 어린이 생태 체험존 현장을 한눈에 미리 살펴보세요.",
    tag: "문화관 탐방 🏛️",
    author: "K-water 물문화 종합포털",
    thumbnail: "/images/cards/kwater_official_facility.png",
    videoUrl: "https://www.youtube.com/@kwatertv",
    embedUrl: "https://www.youtube.com/embed/rO3a8hi0LUI?autoplay=1",
    isShorts: false,
  },
  {
    id: "water-vision-2",
    title: "세상에 행복을 水 놓다 — K-water 물과 자연 이야기",
    desc: "깨끗한 환경과 미래 수자원 기술, 전국 댐 주변 힐링 수변공원과 산책 코스 가이드입니다.",
    tag: "브랜드 하이라이트 🌊",
    author: "K-water Official Channel",
    thumbnail: "/images/cards/kwater_official_tour.png",
    videoUrl: "https://www.youtube.com/@kwatertv",
    embedUrl: "https://www.youtube.com/embed/rO3a8hi0LUI?autoplay=1",
    isShorts: false,
  },
