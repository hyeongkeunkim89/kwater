      ...
      <div className="mt-3.5 space-y-3 flex-1 flex flex-col justify-between">
        {HIGHLIGHT_ITEMS.map((item) => (
          <div
            ...
            className="group cursor-pointer relative h-24 sm:h-28 w-full overflow-hidden rounded-xl border border-slate-200/90 bg-slate-950 shadow-xs transition-all duration-300 hover:shadow-md hover:border-[#004D95]/50 flex-1 min-h-[96px]"
          >
            ...
            <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-900/70 text-white border border-white/30 backdrop-blur-md transition-all duration-300 group-hover:scale-110 group-hover:bg-red-600 group-hover:border-red-500 shadow-md">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-10 p-3 text-white">
              <span className="text-[10px] font-bold text-sky-300/90 block mb-0.5 tracking-wide">
                {item.author}
              </span>
              <h3 className="text-xs sm:text-sm font-black text-white leading-tight line-clamp-1 transition-transform duration-300 ease-out origin-bottom-left group-hover:scale-[1.03] group-hover:text-sky-100 drop-shadow-md">
                {item.title}
              </h3>
            </div>
          </div>
