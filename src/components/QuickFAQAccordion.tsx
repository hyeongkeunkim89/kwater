...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "기본 관람 시간은 **09:00 ~ 18:00** (입장 마감 17:00)입니다. 매주 월요일(일부 센터 월·화) 및 명절 당일은 정기 휴관일이며, 상단 퀵 검색 탭에서 오늘 관람 가능 여부를 바로 확인하실 수 있습니다.",
  },
  {
    id: "faq-3",
    tag: "해설/예약",
  ...
  },
  {
    id: "faq-4",
    tag: "편의시설",
    question: "유모차/휠체어 대여 및 장애인 편의시설이 마련되어 있나요?",
    answer:
      "네, 모든 물문화관 건물 내에 무장애 경사로, 휠체어 리프트/엘리베이터가 구비되어 있습니다. 안내데스크 방문 시 신분증 확인 후 유모차와 휠체어를 무료로 대여해 드립니다.",
  },
];
