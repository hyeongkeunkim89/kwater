...
VALUES (
  ...
  '기획전시실과 넓고 쾌적한 전시홀, 편안한 발코니 휴게전망공간이 마련되어 있는 좌측 문화공간동입니다.', 
  '[{"name": "기획전시실", "link": null}, {"name": "전시홀 2", "link": null}, {"name": "발코니", "link": null}, {"name": "휴게전망공간", "link": null}]'::jsonb, 
...
VALUES (
  ...
  '대청댐의 상설전시실 1~3호 및 넓은 전시홀, 실감영상실, 야외 데크와 엘리베이터를 갖추고 있는 우측 상설전시동입니다.', 
  '[{"name": "상설전시실 1~3", "link": null}, {"name": "전시홀 1", "link": null}, {"name": "실감영상실", "link": null}, {"name": "데크", "link": null}]'::jsonb, 
